# Gemma 4 on Vertex AI — deploy & personalize

A hands-on notebook: deploy an open **Gemma 4** model as your own private endpoint on
Google Cloud's Vertex AI (Agent Platform), then personalize it two ways — **RAG**
...
## What you'll do
1. Deploy Gemma 4 from **Vertex AI Model Garden** and copy the endpoint id.
...
## Requirements
A Google Cloud project with Vertex AI enabled and permission to deploy from Model
